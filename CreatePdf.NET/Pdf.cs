...
public static class Pdf
{
    ...
    ///     .AddText("Hello World", size: TextSize.Large)
    ///     .SaveAsync("output.pdf");
    /// </code>
    /// </example>
    public static Document Create(Dye? backgroundColor = null) => new(backgroundColor ?? Dye.White);
    ...
    /// </code>
    /// </example>
    public static PdfReader Load(Stream pdfStream) => new(pdfStream);
}
